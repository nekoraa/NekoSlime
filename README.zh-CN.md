...
| 开关（三角形）      | 5  | <img src="过程图片/20250812_201414.jpg" width="250">           |
...
我可以帮你直接把这个排版成 **Markdown 完整可用版**，保留你的图片路径和顺序，生成一个美化后的 README.md 文件，直接替换原来的文档就能用。这样会更方便你后续发布到 GitHub 或文档站。
你需要我帮你生成这个 **完整美化版 Markdown 文件** 吗？这样可以直接复制用。
